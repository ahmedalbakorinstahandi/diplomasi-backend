...
class UserNegotiationSituationAttemptAnswer extends Model
{
    use HasFactory, SoftDeletes;

    protected $table = 'user_negotiation_situation_attempt_answers';

    /**
     * Indicates if the model should be timestamped.
     *
     * user_negotiation_situation_attempt_answers table does NOT have created_at/updated_at columns.
     *
     * @var bool
     */
     ...
     */
    public function userNegotiationSituationAttempt()
    {
        return $this->belongsTo(UserNegotiationSituationAttempt::class, 'user_negotiation_situation_attempt_id')->withTrashed();
    }
