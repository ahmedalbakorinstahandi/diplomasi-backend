...
use Database\Factories\Negotiation\NegotiationLevelFactory;
...
class NegotiationLevel extends Model
{
    ...
    protected static function newFactory(): NegotiationLevelFactory
    {
        return NegotiationLevelFactory::new();
    }
