...
return [
    ...
    */
    ...
    'verification_code_email_title' => 'Your verification code',
    'verification_code_email_intro' => 'Use the code below to verify your account.',
    'forgot_password_code_email_subject' => 'Password reset code - Diplomasi',
    'forgot_password_code_email_title' => 'Password reset code',
    'forgot_password_code_email_intro' => 'Use the code below to reset your account password.',
    'account_activation_code_email_subject' => 'Your account activation code - Diplomasi',
    'account_activation_code_email_title' => 'Account activation code',
    'account_activation_code_email_intro' => 'Use the code below to verify your email and continue in the app.',
    ...
    'otp_invalid_or_expired' => 'The verification code is incorrect or has expired.',
    ...
    'account_deletion_code_subject' => 'Your Account Deletion Code',
    'account_deletion_code_message' => 'Hello :first_name, your account deletion code is :code. Valid for :minutes minutes.',
