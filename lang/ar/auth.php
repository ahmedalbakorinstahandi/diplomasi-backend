...
return [
    ...
    */
    ...
    'verification_code_email_title' => 'رمز التحقق الخاص بك',
    'verification_code_email_intro' => 'استخدم الرمز أدناه لإكمال التحقق من حسابك.',
    ...
    'account_activation_code_email_subject' => 'رمز تفعيل حسابك - Diplomasi',
    'account_activation_code_email_title' => 'رمز تفعيل الحساب',
    'account_activation_code_email_intro' => 'استخدم الرمز أدناه لتفعيل بريدك الإلكتروني والمتابعة في التطبيق.',
    'account_already_verified' => 'هذا الحساب مفعّل مسبقاً.',
    ...
    'registration_disabled_by_admin' => 'التسجيل عبر التطبيق متوقف حالياً من قِبَل إدارة دبلوماسي.',
